...
public class UsdtWatcher extends Watcher {
    private final Logger logger = LoggerFactory.getLogger(UsdtWatcher.class);
    @Autowired
    private JsonrpcClient jsonrpcClient;
    @Autowired
    private AccountService accountService;
    private final String usdtPropertyId = "31";
                ...
                for (String txid : list) {
                    ...
                    if (propertyid.equals(this.usdtPropertyId) && valid) {
                        if (accountService.isAddressExist(address)) {
                            ...
                            logger.info("receive usdt {}", map.get("referenceaddress"));
