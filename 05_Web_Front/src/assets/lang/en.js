module.exports = {
    ...
    header: {
        ...
        swap1: "USDT-M Futures",
        swap2: "COIN-M Futures",
        swap3: "CFD",
        swap4: "Second",
        cexchange: "QuikExchange",
        option: "Options",
		second:"Second Futures",
        news: "News",
    ...
    sectionPage: {
        ...
        officialstart: "BIZZAN Official Tutorial",
        oneminutebuy: "Spot",
        oneminutebuytips: "Trade Crypto with advanced tools",
        baseknow: "Futures",
        baseknowtips: "USDT-M Futures、COIN-M Futures",
        baseexchange: "Options",
        baseexchangetips: "Crypto Derivatives",
        usersocial: "Quick Convert",
    ...
    otc: {
        ...
        desc3: "Introduction of the platform services for merchants, Intelligent matching, no need to wait",
    ...
    invite: {
        ...
        pt_card_rule6: "6. The right of final interpretation of free gift cards belongs to BIZZAN.BIZ.",
        pt_card_day: "Days",
    ...
    uc: {
        ...
        finance: {
            ...
            record: {
                ...
                secondfail: "Seconds Futures Failed",
                secondreward: "Second Futures Bonus",
        ...
        member: {
            ...
            assets: "Finance",
            exchange: "Exchange",
            curdelegate: "Open Orders",
            hisdelegate: "Order History",
            otc: "OTC"
        },
        order: {
    ...
    description: {
        ...
        message1: 'All-round financial risk control system and security system, hot and cold wallet, multi-signature system to ensure the safety of funds',
        message2: '24h online audit can prevent customers from missing out the best investment opportunities.',
        message3: 'Global business service network helps you invest in global crypto and trade with global users',
        message4: 'We strictly select the high-quality blockchain projects to eliminate 80% high-risk projects for our customers.',
        scanqrcode: "Download APP",
        aboutdesc1: "BIZZAN.BIZ is a leading digital asset trading platform in the world, registered in the Cayman Islands, with a core operating team in Hong Kong. The core members of BIZZAN.BIZ come from top Internet and financial companies. Most of them are deep believers in Bitcoin and block chains. We are convinced that block chains will change the traditional monopolistic financial system and build a more democratic and autonomous social structure.",
        aboutdesc2: "BIZZAN.BIZ platform has a professional financial-level trading architecture, a self-developed high concurrent memory matching trading engine. The platform uses a full-cold rechargeable wallet system + multiple signatures + high-protection DDOS attack system and other trading architecture to ensure customer asset security.",
        ...
        aboutdesc4: "BIZZAN.BIZ strictly screens high-quality projects and provides secure and stable asset hosting services. BIZZAN.BIZ upholds the concept of “honesty, justice, enthusiasm and openness”, and strives to create a safe, reliable, efficient and friendly ultimate exchange for users.",
