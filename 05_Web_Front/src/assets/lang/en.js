module.exports = {
    common: {
        ...
        set: 'Set',
        update: 'Modify',
        slogan: "The world's leading digital currency exchange",
        subslogan: "Start your crypto investment journey",
        more: "More",
        please: "Please",
        nodata: "No Records",
        pleaseselect: "Select",
    ...
    activity: {
        ...
        submit: "Submit",
        tipsmobile: "Please use PC web（www.bizzan.biz）",
    ...
    invite: {
        ...
        pt_tips: "If you have a good idea, please send an email to promotion@bizzan.biz, with a reward after adoption.！",
        ...
        pt_card_rule6: "6. The right of final interpretation of free gift cards belongs to BizzanEX.COM.",
        pt_card_day: "Days",
    ...
    uc: {
        ...
        finance: {
            ...
            swapassets: 'Swap Assets(U)',
            swapassets2: 'Swap Assets(COIN)',
            ...
            second: {
                secondaccount: "Second contract account",
                swap: " Second contract account"
            },
            finance: {
            ...
            record: {
                ...
                secondfail: "Second contract failed",
                secondreward: "Second Contract Reward",
                financereward: "Finance Interest",
                payChargeFee: "Pay Charge Fee",
                getChargeFee: "Get Funding Fee",
                autoInvestBuy: "AutoInvestBuy",
                autoInvestSell: "Scheduled to sell",
                lockedSavingBuy: "Buy Regularly",
                lockedSavingSell: "Regular redemption",
                ...
                transfer_out_usdt: "U-based contract transfer in",
                transfer_in_second: "Seconds contract transfer in",
                transfer_out_second: "Second contract transfer in",
                transfer_in: "Currency Transfer In",
                transfer_out: "Currency transfer and transfer",
                other: "Other"
            },
            recharge: {
                recharge: 'Deposit',
				...
				network: 'network',
				notaddress: "You have not applied for a recharge address，Please click the button to get the recharge address",
    ...
    description: {
        ...
        message4: 'Our mission is to increase economic freedom in the world，Everyone deserves access to financial services',
        scanqrcode: "Download APP",
        aboutdesc1: "We are building a safe, fair, efficient and transparent cryptocurrency trading platform, and we have the world's leading blockchain trading products. Meta Spark is consistently rated as one of the best places to buy and sell cryptocurrencies online, thanks to our great service, low fees, multiple trading products and strict security standards.",
        aboutdesc2: "Meta Spark platform has a professional blockchain software system, the world's leading matching transaction engine technology, and the platform adopts a transaction structure such as a full cold recharge wallet system + multi-signature + high-protection DDOS attack system to ensure the safety of customer assets.",
        aboutdesc3: "Our vision is to increase the freedom of money globally. We believe that by spreading this freedom, we can significantly improve lives around the world.",
        aboutdesc4: "",
        aboutdesc5: "",
        joindesc1: "Join us and lead the future of the cryptoeconomy, we are the world's most trusted way to join the crypto revolution, serving multiple countries around the world. Come and work with us.",
        joindesc2: "Embrace a challenging future. Accelerate the adoption of cryptocurrencies, blockchain and distributed ledger technology with leaders in the cryptocurrency space.",
        joindesc3: "Take on the task of solving unique and challenging business problems, and Meta Spark will see your success. As a rapidly expanding team, we offer rich opportunities for personal growth.",
        joindesc4: "Meta Spark's core values guide the team's goals, decisions and actions, allowing team collaboration across nationalities, cultures and backgrounds to ultimately realize the Meta Spark team's shared vision.",
        support: "Support",
        report: "Suggestion",
        ...
        wechat: "Wechat",
        addwechat: "Add 'Bizzan' as Wechat friends and then enter Wechat community",
        weibo: "Weibo",
        twitter: "Twitter",
        biyong: "Biyong",
        telegram: "Telegram",
    ...
    earn:{
        ...
        autoPlan: 'Scheduled investment plan',
        autoOrder: 'Scheduled vote record',
        editAutoPlan: 'Modify the scheduled investment plan',
        autoAmount: 'Investment amount',
        autoCycle: 'Investment Cycle',
        daily: 'every day',
        weekly: 'Weekly',
        monthly: 'monthly',
        startTime: 'Start time',
        amountError: 'Please enter the correct amount',
        status: 'on/off',
        orderStatus: 'Status',
        cumulativeAmount: 'Cumulative investment amount',
        cumulativeBuyAmount: "Amount held",
        averagePrice: "Average Cost",
        profitLoss: "Unrealized profit and loss",
        nextTime: "Next scheduled vote date",
        createTime: "Planned creation date",
        investTime: "Fixed Investment Date",
        amount: "Amount of fixed investment",
        fee: "Transaction fee",
        success: "Success",
        fail: "Failed",
        duration: "Duration (days)",
        rate: "Annualized Return",
        earnStartTime: "earning start date",
        earnEndTime: "Redemption Day",
        earnGJNum: "Earning Estimate",
        earnNum: "Earnings",
        startNum: "Starting Quantity",
        cycle: "Cycle Cycle",
        inputAmount: "Enter the investment amount",
        create: "Confirm the plan",
        ty: "3 years",
        oy: "1 year",
        sm: "6 month",
        tm: "3 month",
        createPlan:"Create a plan",
        labdetail: "Bizzan Earn ● One-stop investment solution",
        headertitledesc: "Simple & Secure. Start earning",
