module.exports = {
    ...
    sectionPage: {
        ...
        brandDesc1: "BIZZAN.PRO由一群比特币早期参与者与极客创立，团队核心成员来自于谷歌、微软、阿里巴巴、腾讯等知名企业，具有深厚的研发实力与丰富的互联网产品运营经验。",
        brandDesc2: "BIZZAN.PRO定位于区块链基础服务商，致力于为全球用户提供优质加密资产交易平台，秉承着“不作恶”的基本原则，坚持诚实、公正、热情的服务于客户，以开放的态度迎接一切有利于用户根本利益的伙伴/项目。",
    ...
    activity: {
        ...
        attentiontxt4: "* 本活动最终解释权归币严(WWW.BIZZAN.PRO)官方所有",
        inputamount: "输入兑换数量",
        ...
        submit: "提交",
        tipsmobile: "请进入电脑端页面参与（www.bizzan.pro）",
        tipsmobile1: "请在电脑端打开（www.bizzan.pro）并进入创新实验区参与",
        intvalue: "请输入整数",
    ...
    invite: {
        ...
        partnerlevel: "合伙级别",
        ruledetail: "规则详情",
        ruleprofile1:"币严(WWW.BIZZAN.PRO)的【推广合伙人】是全网",
        ruleprofile2:"返佣比例最高、",
        ruleprofile3:"返佣时长最长(最高终身返佣)",
        ruleprofile4:"的推广活动，让付出相应努力的推广者能够成为真正意义上的平台“合伙人”，享受与币严(WWW.BIZZAN.PRO)交易平台共同成长的红利！具体细则如下：",
        ruletext1: "一、为布道数字资产理念与扩大用户规模，币严(WWW.BIZZAN.PRO)推出【推广合伙人】计划，该活动长期有效。",
        ...
        thanks: "感谢您陪着币严(WWW.BIZZAN.PRO)一起成长！",
        headertip: "以上佣金数据非实时更新，系统每24H统计并更新一次。",
        ptools: "推广工具箱",
        pt_title: "数字货币礼品卡",
        pt_desc: "兑换后自动成为下级好友，送朋友、送亲人、送客户、送伙伴。助力推广合伙人更好推广。",
        pt_more: "更多工具，敬请期待",
        pt_tips: "如果您有好的创意，请发送邮件至promotion@bizzan.pro，采纳后有奖励哦！",
        pt_card_amount: "卡面金额",
        ...
        pt_card_rule2: "二、免费礼品卡每个用户限兑1份。由币严(WWW.BIZZAN.PRO)官方发放的免费礼品卡，每个用户限兑一份，即使通过不同用户领取到不同兑换码的免费礼品卡，也只能兑换1份。自定义制作礼品卡不受此限制。",
        ...
        pt_card_rule6: "六、免费礼品卡最终解释权归BIZZAN.PRO所有。",
        pt_card_day: "天",
    ...
    description: {
        ...
        message5: '币严(WWW.BIZZAN.PRO)国际数字加密资产交易平台手机客户端，专注掌上交易体验',
        scanqrcode: "扫描二维码，下载APP",
        aboutdesc1: "币严(WWW.BIZZAN.PRO)是技术全球领先的数字资产交易平台，注册于开曼群岛，核心运营团队位于香港。币严(WWW.BIZZAN.PRO)核心成员来自于顶级互联网和金融公司，大部分成员是深度比特币和区块链信仰者，我们深信区块链将改变传统垄断性金融体系，会建立一个更加民主、自治的社会结构。",
        aboutdesc2: "币严(WWW.BIZZAN.PRO)平台拥有专业金融级别的交易架构，拥有自主研发的高并发内存撮合交易引擎，平台采用全冷充值钱包系统+多重签名+高防护DDOS攻击系统等交易架构，保证客户资产安全。",
        aboutdesc3: "币严(WWW.BIZZAN.PRO)为了让客户更好的把握投资机会，客服部门内部采用扁平化管理，建立了极速服务响应机制，资产客服经理常年7*24H在线，为客户提供资产充值提现等服务，保障客户在25分钟内完成资产充提。",
        aboutdesc4: "币严(WWW.BIZZAN.PRO)严格筛选优质项目并提供安全稳定的资产托管服务。币严(WWW.BIZZAN.PRO)秉承着“诚实、公正、热情、开放”的理念，竭力为用户打造安全、可靠、高效和友好的极致交易所。",
