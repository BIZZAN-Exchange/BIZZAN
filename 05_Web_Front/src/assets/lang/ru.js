module.exports = {
    ...
    sectionPage: {
        ...
        brandDesc1: "WWW.EPBITCOIN.COM был основан группой первых участников Биткойн и компьютерных фанатов. Основные члены команды - представители известных компаний, таких как Google, Microsoft, Alibaba, Tencent и т. Д., С глубокими исследованиями и разработками и богатыми опыт эксплуатации интернет-продуктов. ",
    ...
    invite: {
        ...
        pt_tips: 'Если у вас есть хорошая идея, отправьте электронное письмо на адрес promo@bizzan.biz, после принятия будут награды!',
    ...
    uc: {
        ...
        finance: {
            ...
            record: {
                ...
                payChargeFee: "Оплатить комиссию",
                getChargeFee: "Получить комиссию за финансирование",
                autoInvestBuy: "АвтоИнвестКупить",
                autoInvestSell: "Запланирована продажа",
                lockedSavingBuy: "Покупать регулярно",
                lockedSavingSell: "Регулярное погашение",
                transfer_in_coin: "Перевод стандартного контракта в валюту",
                transfer_out_coin: "Перевод стандартного контракта на валюту",
                transfer_in_usdt: "Передача контракта U-standard в",
                transfer_out_usdt: "Передача контракта на основе U",
                transfer_in_second: "Передача контракта на секунды",
                transfer_out_second: "Передача второго контракта в",
                transfer_in: "Перевод валюты в",
                transfer_out:"Перевод и перевод валюты",
                other: "Другие"
            },
            paydividende: {
            ...
            recharge: {
				...
				network: 'Інтэрнэт',
				notaddress: "Вы не падалі заяўку на адрас дэпазіту，Калі ласка, націсніце кнопку, каб атрымаць адрас дэпазіту",
        ...
        regist: {
            hasaccount: 'Уже есть учетная запись? Пожалуйста, нажмите, чтобы войти ',
            login: 'Авторизоваться',
            tellogin: 'Войти с телефона',
            emaillogin: 'Электронная почта Войти',
    ...
    earn:{
        lockedSavings: "Регулярное управление финансами",
        autoInvest: "Финансовое управление инвестициями в основной капитал",
        minNumErr: 'Меньше минимальной начальной суммы',
        autoPlan: 'Запланированный инвестиционный план',
        autoOrder: 'Запланированная запись голосования',
        editAutoPlan: 'Изменить запланированный инвестиционный план',
        autoAmount: 'Сумма инвестиции',
        autoCycle: 'Инвестиционный цикл',
        daily: 'каждый день',
        weekly: 'Еженедельно',
        monthly: 'ежемесячно',
        startTime: 'Время начала',
        ...
        orderStatus: 'Статус',
        cumulativeAmount: 'Сумма инвестиций',
        cumulativeBuyAmount: "Удерживаемая сумма",
        averagePrice: "Средняя стоимость",
        profitLoss: "Нереализованная прибыль и убыток",
        nextTime: "Дата следующего запланированного голосования",
        createTime: "Планируемая дата создания",
        investTime: "Фиксированная дата инвестирования",
        amount: "Сумма основных инвестиций",
        fee: "Комиссия за транзакцию",
        success: "Успех",
        fail: "Не удалось",
        duration: "Продолжительность (дни)",
        rate: "одовая доходность",
        earnStartTime: "дата начала заработка",
        earnEndTime: "День искупления",
        earnGJNum: "Оценка дохода",
        earnNum: "Заработок",
        startNum: "Начальное количество",
        cycle: "Цикл Цикл",
        inputAmount: "Введите сумму инвестиции",
        create: "Подтвердить план",
        ty: "3 года",
        oy: "1 год",
        sm: "6 месяцев",
        tm: '3 месяца',
