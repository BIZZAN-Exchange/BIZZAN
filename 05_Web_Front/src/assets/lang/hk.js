module.exports = {
    ...
    activity: {
        ...
        attentiontxt4: "* 本活動最終解釋權歸幣嚴(WWW.BIZZAN.PRO)官方所有",
        inputamount: "輸入兌換數量",
        ...
        submit: "提交",
        tipsmobile: "請進入電腦端頁面參與（www.bizzan.pro）",
        tipsmobile1: "請在電腦端打開（www.bizzan.pro）並進入創新實驗區參與",
        intvalue: "請輸入整數",
    ...
    invite: {
        ...
        partnerlevel: "合夥級別",
        ruledetail: "規則詳情",
        ruleprofile1: "幣嚴(WWW.BIZZAN.PRO)的【推廣合夥人】是全網",
        ruleprofile2: "返佣比例最高、",
        ruleprofile3: "返佣時長最長(最高終身返佣)",
        ruleprofile4: "的推廣活動，讓付出相應努力的推廣者能夠成為真正意義上的平台“合夥人”，享受與幣嚴(WWW.BIZZAN.PRO)交易平台共同成長的紅利！具體細則如下：",
        ruletext1: "一、為佈道數字資產理念與擴大用戶規模，幣嚴(WWW.BIZZAN.PRO)推出【推廣合夥人】計劃，該活動長期有效。",
        ...
        thanks: "感謝您陪著幣嚴(WWW.BIZZAN.PRO)一起成長！",
        ...
        pt_card_rule2: "二、免費禮品卡每個用戶限兌1份。由幣嚴(WWW.BIZZAN.PRO)官方發放的免費禮品卡，每個用戶限兌一份，即使通過不同用戶領取到不同兌換碼的免費禮品卡，也只能兌換1份。自定義製作禮品卡不受此限制。",
    ...
    description: {
        ...
        message5: '幣嚴(WWW.BIZZAN.PRO)國際數字加密資產交易平台手機客戶端，專注掌上交易體驗',
        scanqrcode: "掃描二維碼，下載APP",
        aboutdesc1: "幣嚴(WWW.BIZZAN.PRO)是技術全球領先的數字資產交易平台，註冊於開曼群島，核心運營團隊位於香港。幣嚴(WWW.BIZZAN.PRO)核心成員來自於頂級互聯網和金融公司，大部分成員是深度比特幣和區塊鏈信仰者，我們深信區塊鏈將改變傳統壟斷性金融體系，會建立一個更加民主、自治的社會結構。",
        aboutdesc2: "幣嚴(WWW.BIZZAN.PRO)平台擁有專業金融級別的交易架構，擁有自主研發的高並發內存撮合交易引擎，平台採用全冷充值錢包系統+多重簽名+高防護DDOS攻擊系統等交易架構，保證客戶資產安全。",
        aboutdesc3: "幣嚴(WWW.BIZZAN.PRO)為了讓客戶更好的把握投資機會，客服部門內部採用扁平化管理，建立了極速服務響應機制，資產客服經理常年7*24H在線，為客戶提供資產充值提現等服務，保障客戶在25分鐘內完成資產充提。",
        aboutdesc4: "幣嚴(WWW.BIZZAN.PRO)嚴格篩選優質項目並提供安全穩定的資產託管服務。幣嚴(WWW.BIZZAN.PRO)秉承著“誠實、公正、熱情、開放”的理念，竭力為用戶打造安全、可靠、高效和友好的極致交易所。",
