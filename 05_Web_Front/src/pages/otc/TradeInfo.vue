            ...
            <div class="trade-right-box">
              <div class="trade-price">
                <p>
                  ...
                  <span>{{user.price}} {{user.currency}} / {{user.unit}}</span>
                  <!-- <span @click="update">
                ...
                <p>
                  ...
                  <span>{{user.minLimit}} - {{user.maxLimit}} {{user.currency}}</span>
                </p>
                <p>
...
<!--                </p>-->
              ...
              <div class="trade-operation">
                  ...
                  <p class="price-input-list">
                    <Poptip trigger="focus" :content="text1" style="width: 100%;">
                      <Input @on-change="transform1" v-model="buyPrice" size="large" :placeholder="$t('otc.tradeinfo.amounttip')" style="width: 420px">
                        <span slot="prepend">{{user.currency}}</span>
                      </Input>
                    </Poptip>
                  </p>
                ...
                <div class="price-box">
                  <p class="show-price">
                    <em>{{type}}:</em>
                    <span>&nbsp;&nbsp;{{buyPrice}} {{user.currency}} / {{nuyNum}} {{user.unit}}</span>
                  </p>
      ...
      this.$http
          ...
          .then(response => {
            ...
            if (resp.code == 0) {
              ...
              //翻译国家
              this.user.country = this.$t("uc.regist."+this.countriesStrKey[this.user.country]);
