                          ...
                          <Row class="bottom-panel">
                              <Col span="24">
                                <div class="bottom">
                                    ...
                                    <Button v-if="item.step==1" type="warning" :to="'/mlab/detail/'+ item.id" target="_blank">{{$t('activity.viewdetail')}}</Button>
                                    <Button v-else type="primary" :to="'/mlab/detail/'+ item.id" target="_blank">{{$t('activity.viewdetail')}}</Button>
                                </div>
                                <div class="bottom-mobile">
                                    <p><span><Icon type="md-information-circle" /> {{item.detail}}</span></p>
                                    <Button v-if="item.step==1" long type="warning" :to="'/mlab/detail/'+ item.id">{{$t('activity.viewdetail')}}</Button>
                                    <Button v-else type="primary" long :to="'/mlab/detail/'+ item.id">{{$t('activity.viewdetail')}}</Button>
                                </div>
                              </Col>
                          </Row>
                        </div>
...
export default {
  ...
  methods: {
    ...
    detail(aId){
      this.$router.push("#/mlab/detail/" + aId);
    },
    pageChange(page){
