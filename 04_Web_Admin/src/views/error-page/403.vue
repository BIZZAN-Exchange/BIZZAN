        ...
        <div class="error403-body-con">
            <Card>
                ...
                <div class="error403-btn-con">
                    <Button @click="goLogin" size="large" style="width: 200px;" type="text">{{ $t('youdonthavepermission.loginagain') }}</Button>
                    <Button @click="goHome" size="large" style="width: 200px;margin-left: 40px;" type="primary">{{ $t('oopstheserveriswrong.returntothehomepage') }}</Button>
                </div>
            </Card>
        </div>
    </div>
